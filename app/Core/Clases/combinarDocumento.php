<?php
  ...
  ini_set('max_execution_time', 500000);
    ...
    private $headerAndFootersArray = array();
...
include_once 'RutaAplicacion.php';
...
for ($i = 1, $tamano = sizeof($array); $i < $tamano; $i++) {
    ...
    $archivos[$i - 1] = trim($archivos[$i - 1]);
}
...
$dm->merge($archivos, "../../factcontSoftDocumento/documento/$nombreDocumento.docx" );
...
$archivos = array();
    ...
    $archivos[0] = "../../factcontSoftDocumento/documento/e18dc94743cd0f8bb7bc5740e7e8bf0970776617.docx";
    $archivos[0] = trim($archivos[0]);
    $archivos[1] = "../../factcontSoftDocumento/documento/32b61d124820df97fdb9caf69600b3e712fb6d97.docx";
    $archivos[1] = trim($archivos[1]);
...
switch (substr($_SERVER['SERVER_NAME'], 0, 3)) {
    case "127":
    case "192":
        exec('"C:\Program Files (x86)\LibreOffice 5\program\python.exe" C:\wamp\www\factcontSoft\clases\libreriasExternas\unoconv-master\unoconv -f pdf -o C:\wamp\www\factcontSoftDocumento\documento\\' . $nombreDocumento . '.pdf C:\wamp\www\factcontSoftDocumento\documento\\' . $nombreDocumento . '.docx');
        break;
    default:
        exec("libreoffice4.3 --invisible --convert-to pdf '" . $rutaAplicacion->rutaDocumentoRelativa . 'documento/' . $nombreDocumento . ".docx' --outdir " . $rutaAplicacion->rutaDocumentoRelativa . 'documento/', $aux);
}
//echo $rutaAplicacion->rutaDocumentoAbsoluta . 'documento/' . $nombreDocumento . '.docx';
